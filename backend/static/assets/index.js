...
F.default = F;
const cE = (e) => async (t) => {
    const n = "http://127.0.0.1:8000/products/";
    try {
      t($r()),
        (
          await F.post(n, e, {
  ...
  Rc = (e, t, n) => async (r) => {
    const s = `http://127.0.0.1:8000/products/?page=${e}&sort=${t}&by=${n}`;
    try {
      r($r());
  ...
  Pc = (e, t, n, r) => async (s) => {
    const o = `http://127.0.0.1:8000/products/?search=${e}&page=${r}&sort=${t}&by=${n}`;
    try {
      s($r());
  ...
  dE = (e) => async (t) => {
    const n = `http://127.0.0.1:8000/products/${e}`;
    try {
      t($r());
  ...
  fE = (e, t) => async (n) => {
    const r = `http://127.0.0.1:8000/products/${e}/`;
    try {
      n($r()),
        (
          await F.patch(r, t, {
  ...
  pE = (e, t) => async (n) => {
    const r = `http://127.0.0.1:8000/product-update/${e}`;
    try {
      (
...
const Vy = Hs({
  ...
  jE = Vy.reducer,
  SE = (e) => async (t) => {
    const n = "http://127.0.0.1:8000/cart/";
    try {
      t(Gs());
  ...
  EE = (e, t) => async (n) => {
    const r = `http://127.0.0.1:8000/cart/${e}/?page=${t}`;
    try {
      n(Gs());
  ...
  CE = (e, t) => async (n) => {
    const r = `http://127.0.0.1:8000/cart/${e}/`;
    try {
      n(Gs()),
        (
  ...
  NE = (e) => async (t) => {
    const n = `http://127.0.0.1:8000/cart/${e}`;
    try {
  ...
  kE = (e) => async (t) => {
    const n = `http://127.0.0.1:8000/cart-delete/${e}/`;
    try {
...
const Gy = Hs({
  ...
  TE = Gy.reducer,
  LE = (e) => async (t) => {
    const n = "http://127.0.0.1:8000/orders/";
    try {
      t(Qs());
      const r = await F.post(n, JSON.stringify(e), {
        headers: { "content-type": "application/json" },
  ...
  qy = (e, t) => async (n) => {
    const r = `http://127.0.0.1:8000/orders/?page=${e}&status=${t}`;
    try {
      n(Qs());
      const s = await F.get(r);
  ...
  IE = (e, t) => async (n) => {
    const r = `http://127.0.0.1:8000/orders/${e}/?page=${t}`;
    try {
      n(Qs());
      const s = await F.get(r);
      s.status === 200 && n(Qy(s.data));
  ...
  DE = (e) => async (t) => {
    const n = `http://127.0.0.1:8000/orders/pending/${e}/`;
    try {
      const r = await F.get(n);
  ...
  UE = Xy.reducer,
  BE = (e) => async (t) => {
    const n = "http://127.0.0.1:8000/summary/";
    try {
      t(Yy()),
        (
  ...
  bE = (e, t) => async (n) => {
    const r = `http://127.0.0.1:8000/summary/?page=${e}&sort=${t}`;
    try {
      n(Yy());
      const s = await F.get(r);
...
const eg = Hs({
  ...
  GE = eg.reducer,
  QE = (e) => async (t) => {
    const n = "http://127.0.0.1:8000/login/";
    try {
      t(Jn());
      const r = await F.post(n, JSON.stringify(e), {
        headers: { "content-type": "application/json" },
  ...
  JE = (e) => async (t) => {
    const n = "http://127.0.0.1:8000/users/";
    try {
      t(Jn());
      const r = await F.post(n, JSON.stringify(e), {
        headers: { "content-type": "application/json" },
  ...
  qE = (e) => async (t) => {
    const n = `http://127.0.0.1:8000/users/?page=${e}`;
    try {
      t(Jn());
      const r = await F.get(n);
  ...
  ng = (e, t) => async (n) => {
    const r = `http://127.0.0.1:8000/users/?search=${e}&page=${t}`;
    try {
      n(Jn());
      const s = await F.get(r);
  ...
  If = (e) => async (t) => {
    const n = `http://127.0.0.1:8000/users/${e.Id}/`;
    try {
      t(Jn());
  ...
  YE = (e) => async (t) => {
    const n = `http://127.0.0.1:8000/users/${e}`;
    try {
